...
BEGIN {
  $Bio::Chado::Schema::Mage::Studydesignprop::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Mage::Studydesignprop::VERSION = '0.06302';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YPbsYdKk2aEAPbmOtxt4Yg
