...
BEGIN {
  $Bio::Chado::Schema::CellLine::CellLineDbxref::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::CellLine::CellLineDbxref::VERSION = '0.07100';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P752ISgJF+TaBRi7aqkKLA
