...
BEGIN {
  $Bio::Chado::Schema::Cv::CvLinkCount::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Cv::CvLinkCount::VERSION = '0.07100';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:x7wBQatVBIvYZgrSK5N1Ng
