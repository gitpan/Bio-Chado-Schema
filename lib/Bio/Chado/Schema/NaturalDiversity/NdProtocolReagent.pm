package Bio::Chado::Schema::NaturalDiversity::NdProtocolReagent;
BEGIN {
  $Bio::Chado::Schema::NaturalDiversity::NdProtocolReagent::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::NaturalDiversity::NdProtocolReagent::VERSION = '0.07000';
}
