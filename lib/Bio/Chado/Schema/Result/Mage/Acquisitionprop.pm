...
BEGIN {
  $Bio::Chado::Schema::Result::Mage::Acquisitionprop::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Result::Mage::Acquisitionprop::VERSION = '0.08001'; # TRIAL
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zmbSCGdvwVW0aSHkIpUGFg
