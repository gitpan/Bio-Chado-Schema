package Bio::Chado::Schema::Result::Sequence::FeatureRelationship;
BEGIN {
  $Bio::Chado::Schema::Result::Sequence::FeatureRelationship::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Result::Sequence::FeatureRelationship::VERSION = '0.09000';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NyvyWCI4DfPZrKeQuyx1CQ
