...
BEGIN {
  $Bio::Chado::Schema::Phylogeny::Phylotree::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Phylogeny::Phylotree::VERSION = '0.07300';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K4VIwBdNVGkfj3vA72dz+Q
