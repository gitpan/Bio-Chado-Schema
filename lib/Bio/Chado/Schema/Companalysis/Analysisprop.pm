...
BEGIN {
  $Bio::Chado::Schema::Companalysis::Analysisprop::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Companalysis::Analysisprop::VERSION = '0.07000';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JL/SOMtCovV9UeYv0jkKHg
