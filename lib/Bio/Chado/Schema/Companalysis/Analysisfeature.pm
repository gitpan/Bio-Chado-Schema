...
BEGIN {
  $Bio::Chado::Schema::Companalysis::Analysisfeature::AUTHORITY = 'cpan:RBUELS';
}
BEGIN {
  $Bio::Chado::Schema::Companalysis::Analysisfeature::VERSION = '0.06302';
}
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NFqlF+RwRLHn4yncFqD75w
